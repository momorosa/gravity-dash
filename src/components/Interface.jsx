...
export default function Interface()
{
    ...
    return <div className="fixed top-0 left-0 w-full h-screen pointer-events-none font-primary">
        ...
        <div
            id="reset-button" 
            className="absolute top-4 right-0 text-2xl text-white font-bold flex justify-center items-center w-50 bg-red-700 py-4 mr-6 pointer-events-auto cursor-pointer"
        >
            Restart
        </div>
        ...
        <div className="flex flex-col items-center absolute bottom-24 right-16">
            <div className="flex justify-center">
                <div className={`m-2 bg-white size-16 border-4 border-gray-300 border-solid transition-all duration-200 
            ...
            <div className="flex justify-center">
                <div className={`m-2 bg-white w-[210px] h-16 border-4 border-gray-300 border-solid transition-all duration-200 
        ...
        <div id="controls" className="flex items-center absolute bottom-24 left-16">
            <div id="raw" className="flex justify-center">
                <div className="m-2 bg-white opacity-50 w-64 h-8 border-4 border-gray-300 border-solid">
